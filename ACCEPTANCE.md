...
| Q-005 | 当前源码构建 wheel/sdist 并通过 metadata 检查 | PASS | Hatchling 1.32.0、`--no-isolation`；两次构建字节一致；Twine strict/check-wheel/audit 通过 | wheel `a33dcc22...ac9558`；sdist `268e3497...5569e` |
