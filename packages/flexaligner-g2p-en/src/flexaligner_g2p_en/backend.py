...
class EnglishG2PError(ValueError):
    """Stable internal error translated by the main FlexAligner adapter."""
...
class LocalEnglishG2P:
    ...
    def __init__(self) -> None:
        ...
        if set(self._arrays) != required:
            raise EnglishG2PError("English G2P checkpoint has unexpected variables")
